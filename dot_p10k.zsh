# Generated by Powerlevel10k configuration wizard on 2026-01-01 at 20:42 AEDT.
...
# round separators, round heads, blurred tails, 2 lines, disconnected, no frame,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#161616'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#F77AB0'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#FF0066'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#FF0066'
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#F2F4F8'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#F2F4F8'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#F77AB0'
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#161616'

  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#161616'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#E5C07B'
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#E06C75'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#161616'
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#98C379'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#E06C75'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=183
  ...
  function prompt_hermit() {
    if [[ -n $HERMIT_ENV ]]; then
      p10k segment -t "${${HERMIT_ENV:t}//\%/%%} 🐚"  -f 231 -b 197
    fi
  }

  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=231          # white text
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=183
